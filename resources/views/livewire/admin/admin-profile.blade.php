                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        <div class="row">
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    <div>
                                        <span class="heading">{{ auth()->user()->dob }}</span>
                                        <span class="description">Date of Birth</span>
                                    </div>
                                    <div>
                                        <span class="heading">{{ auth()->user()->gender }}</span>
                                        <span class="description">Gender</span>
                                    </div>
                                    <div>
                                        <span class="heading">{{ auth()->user()->phone }}</span>
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-center">
                                <a href="{{ route('admin.edit',['admin_id'=>$admin->id]) }}">
